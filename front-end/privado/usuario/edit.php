...
<!--   <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom01" name="id_user" required>
 ...
 -->
  ...
  <div class="col-md-3">
    ...
    value="<?php echo $usuario->tarjeta?>" required> 
  ...
  <div class="col-md-4">
    ...
    value="<?php echo $usuario->contacto?>" required>
    <!--     <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
